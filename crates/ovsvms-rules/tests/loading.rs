...
use ovsvms_core::{Identifier, PayloadEncoding, ResourceLimits, SchemaVersion, SignedRuleEnvelope};
use ovsvms_rules::{
...
const JSON: &str = include_str!("../../ovsvms-core/tests/fixtures/rule-set-v1.json");
const YAML: &str = include_str!("../../ovsvms-core/tests/fixtures/rule-set-v1.yaml");
...
fn signing_bytes_match_the_documented_binary_format() {
    ...
    let expected = concat!(
        "4f5653564d532d52554c452d454e56454c4f50452d563100",
        "0001",
        "0000000161",
        "0000000000000001",
        "000000016b",
...
fn independent_ed25519_vector_matches_the_signing_format() {
    ...
    envelope.expires_at_unix_ms = 2;
    envelope.signature_base64url =
        "A8CUzNrNR4v4u7lDPgQXN9tn_j_fzIdexVzD68v_nXAhZVPKVaHxqbI6VxI1EoUExADKjFHkogYYzUwCY3coCQ"
            .into();
    ...
    assert_eq!(
        hash,
        "40eefb4ed489a9e2705f233eda1b1b4b9612dc50ff8f337d52e02f2c498242ef"
    );
